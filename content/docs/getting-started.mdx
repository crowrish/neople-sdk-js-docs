...
<a href="https://www.npmjs.com/package/neople-sdk-js">
  <img src="https://img.shields.io/npm/v/neople-sdk-js.svg?style=flat-square" alt="npm version" width="110" height="20" />
</a>{' '}
<a href="https://www.npmjs.com/package/neople-sdk-js">
  <img src="https://img.shields.io/npm/dm/neople-sdk-js.svg?style=flat-square" alt="npm downloads" width="140" height="20" />
</a>
...
자세한 내용은 [HTTP 어댑터 가이드](/docs/adapter-fetch)를 참조하세요.
...
- [설정 및 고급 옵션](/docs/configuration)
- [HTTP 어댑터 선택](/docs/adapter-fetch)
- [API 레퍼런스 - 던전앤파이터](/docs/api-dungeon-fighter)
- [API 레퍼런스 - 사이퍼즈](/docs/api-cyphers)
- [오류 처리 가이드](/docs/error-handling)
- [예제 및 사용 패턴](/docs/examples)
